...
const NavItem: React.FC<{
  ...
  <button
    ...
    aria-label={label}
  >
    {/* Active Indicator - small dot instead of line for cleaner look */}
    {isActive && (
  ...
  return (
    <nav className="w-28 bg-slate-200/50 border-r border-slate-300/50 flex flex-col items-center py-6 z-50 backdrop-blur-sm h-full">
      <div className="mb-10 p-2">
        <div className="bg-gradient-to-br from-sky-600 to-sky-800 p-3.5 rounded-2xl shadow-xl shadow-sky-700/20 transform hover:scale-105 transition-transform duration-300">
      ...
      <div className="flex-1 space-y-1 w-full px-3 flex flex-col items-center overflow-y-auto no-scrollbar">
        ...
        <NavItem
            label="Rateio"
            icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2-2v14a2 2 0 002 2z" /><path strokeLinecap="round" strokeLinejoin="round" d="M16 3h5v5M4 20L21 3M21 16v5h-5M3 8H8V3" /></svg>}
            isActive={activeView === 'proration'}
            onClick={() => setActiveView('proration')}
        />
        <NavItem
            label="Notas"
            icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>}
