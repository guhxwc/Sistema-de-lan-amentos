        ...
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-7 gap-4 items-end">
          ...
          <div className="lg:col-span-1">
            <Select
              label="UF Destino"
              name="uf_destination"
              value={newFreight.uf_destination || ""}
              onChange={handleChange}
            >
              <option value="">--</option>
              {UF_LIST.map((uf) => (
          ...
          <div className="md:col-span-2 lg:col-span-3 grid grid-cols-2 gap-2">
            ...
            <Button onClick={onAddFreight} className="w-full">
              Adicionar
            </Button>
            <input
              type="file"
